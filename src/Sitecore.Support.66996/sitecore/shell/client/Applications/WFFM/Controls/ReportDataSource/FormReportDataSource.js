define(["jquery", "sitecore"], function($, sc) {
  ...
  var model = sc.Definitions.Models.ComponentModel.extend({
    ...
    getFormData: function(pageIndex) {
      ...
      $.ajax({
        cache: false,
        type: 'POST',
        url: "/api/sitecore/SupportFormReports/GetFormContactsPage",
        data: JSON.stringify({ "id": formId, pageCriteria: pageCriteria, sortCriteria: pageCriteria.Sorting }),
        dataType: 'json',
        context: this,
  ...
  sc.Factories.createComponent("FormReportDataSource", model, view, "script[type='text/x-sitecore-formreportdatasource']");
});